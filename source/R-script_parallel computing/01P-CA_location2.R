...
#wget https://cran.r-project.org/src/contrib/TDA_1.9.1.tar.gz
#install.packages("~/TDA/TDA_1.9.1.tar.gz", repos = NULL, type = "source")

vals  <-  commandArgs(trailingOnly = TRUE)
V_in  <-  as.integer(vals[1])
V_out <-  as.integer(vals[2])
